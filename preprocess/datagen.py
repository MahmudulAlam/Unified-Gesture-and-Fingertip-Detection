...
def label_generator(image_name, type):
...
if __name__ == '__main__':
    image_name = 'ChuangyeguFirstfloor_Single_Four_color_335.jpg'
    directory = '../../EgoGesture Dataset/'
    image, prob, key = label_generator(image_name=image_name, type='Test')
    print(key)
    index = 0
