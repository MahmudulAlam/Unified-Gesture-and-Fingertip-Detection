import cv2
import numpy as np
from preprocess.find_folder import find_folder, finger_type

directory = '../EgoGesture Dataset/'


def label_generator_testset(image_name, initial):
    """
    ...
    image = cv2.imread(directory + folder_name + initial + '/' + image_name)
...
if __name__ == '__main__':
    image_name = 'ChuangyeguBusstop_Single_Six_color_18.jpg'
    directory = '../../EgoGesture Dataset/'
    original_image, tl, cropped_image, ground_truths = label_generator_testset(image_name=image_name,
                                                                               initial='Test')
