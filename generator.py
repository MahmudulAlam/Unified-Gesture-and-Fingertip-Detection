...
def train_generator(sample_per_batch, batch_number):
    ...
    for folder in folder_name:
        train_image_file = train_image_file + os.listdir('../EgoGesture Dataset/' + folder + '/')
    ...
    while True:
        for i in range(0, batch_number - 1):
            ...
            for n in range(start, end):
                ...
                try:
                    image, probability, position = label_generator(image_name=image_name, type='')
                except cv2.error:
                    print(image_name)
                    continue
...
def valid_generator(sample_per_batch, batch_number):
    ...
    for folder in folder_name:
        valid_image_file = valid_image_file + os.listdir('../EgoGesture Dataset/' + folder + '/')
    ...
    while True:
        for i in range(0, batch_number - 1):
            ...
            for n in range(start, end):
                ...
                try:
                    image, probability, position = label_generator(image_name=image_name, type='Valid')
                except cv2.error:
                    print(image_name)
                    continue
