...
def file_reader(file_name):
    file_directory = '../../EgoGesture Dataset/label/'
    file = open(file_directory + file_name + '.txt')
...
if __name__ == '__main__':
    image_name = 'ChuangyeguBusstop_Single_Nine_color_27.jpg'
